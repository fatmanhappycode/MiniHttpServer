...
class ServerImpl {
     ...
     * @param connection 连接
     */
    private void requestStarted (HttpConnection connection) {
     ...
     * @param connection 连接
     */
    private void responseCompleted(HttpConnection connection) {
     ...
     */
    private synchronized  HttpContextImpl findContext(String protocol, String path) {
